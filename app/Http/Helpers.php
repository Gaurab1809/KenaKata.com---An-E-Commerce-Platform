...
<?php
    ...
    {
        return config('currency.currency_symbol', 'Taka');
    }

    // Format currency with proper positioning
    public static function formatCurrency($amount, $currency = null)
    {
        $currency = $currency ?: config('currency.default_currency', 'BDT');
        $symbol = config('currency.currency_symbol', 'Taka');
        $position = config('currency.currency_position', 'after');
    ...
    public static function orderPrice($order_id, $user_id)
    {
