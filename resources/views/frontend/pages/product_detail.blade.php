...
@endsection
@section('title','KenaKata.com || PRODUCT DETAIL')
									...
									<div class="col-lg-6 col-12">
										<div class="product-des">
											...
											<div class="short">
                                                ...
                                                @endphp
												<p class="price"><span class="discount">{{number_format($after_discount,2)}} Taka</span><s>{{number_format($product_detail->price,2)}} Taka</s> </p>
                                ...
                                <div class="single-product">
                                    ...
                                    <div class="product-content">
                                        ...
                                        <div class="product-price">
                                            ...
                                            @endphp
                                            <span class="old">{{number_format($data->price,2)}} Taka</span>
